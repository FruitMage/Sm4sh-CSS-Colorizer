...
namespace Sm4sh_CSS_Colorizer
{
    public partial class Form1 : Form
    {
        ...
        {
            //Color Conversion
            string color1 = ColorTranslator.ToHtml(colorDisplay1.BackColor).Replace("#", "");
            char[] color1Char = color1.ToCharArray();
            string color2 = ColorTranslator.ToHtml(colorDisplay2.BackColor).Replace("#", "");
            char[] color2Char = color2.ToCharArray();
            string color3 = ColorTranslator.ToHtml(colorDisplay3.BackColor).Replace("#", "");
            char[] color3Char = color3.ToCharArray();
            string color4 = ColorTranslator.ToHtml(colorDisplay4.BackColor).Replace("#", "");
            char[] color4Char = color4.ToCharArray();
            string color5 = ColorTranslator.ToHtml(colorDisplay5.BackColor).Replace("#", "");
            char[] color5Char = color5.ToCharArray();
            //
            //Debug stuff
            Console.WriteLine(color1Char[0].ToString());
            //
            //Color 1
            int color1RedX = 0;
